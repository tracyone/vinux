...
vim.keymap.set('n', '\\', ":silent! Telescope current_buffer_fuzzy_find<CR>", {})
vim.keymap.set('n', '<leader>ff', ":silent! Telescope file_browser<CR>", {})
vim.keymap.set('n', '<leader>fe', ":silent! Telescope feat en=1<CR>", {})
vim.keymap.set('n', '<leader>fd', ":silent! Telescope feat en=0<CR>", {})
