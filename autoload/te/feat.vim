...
function! te#feat#gen_feature_vim(reset) abort
    ...
    if type(l:vinux_version) == g:t_number || v:shell_error != 0
        let g:vinux_version='vinux V1.9.6'.' @'.l:temp2[0].'.'.l:temp2[1]
    else
...
function! te#feat#init_all() abort
    ...
    call te#feat#init_var('g:ai_llm_model_name', ['ernie-speed-128k',  'deepseek-r1', 'qwen-max', 'qwen-coder-plus', 'qwen-long'])
